<template>
  ...
  <div class="content_plate">
    ...
    <div class="life_details_font"><img src="../../../static/images/delicate_life/img_delicate_lifefont.png"/></div>
    ...
    <a class="life_details_plate" :href="dataList.length>0?dataList[6].url:''"><img src="../../../static/images/delicate_life/img_delicate_life07.png"/></a>

    <a class="life_details_plate" :href="dataList.length>0?dataList[7].url:''"><img src="../../../static/images/delicate_life/img_delicate_life08.png"/></a>

    <a class="life_details_plate" :href="dataList.length>0?dataList[8].url:''"><img src="../../../static/images/delicate_life/img_delicate_life09.png"/></a>

    <a class="life_details_plate" :href="dataList.length>0?dataList[9].url:''"><img src="../../../static/images/delicate_life/img_delicate_life10.png"/></a>

    <a class="life_details_plate" :href="dataList.length>0?dataList[10].url:''"><img src="../../../static/images/delicate_life/img_delicate_life11.png"/></a>
