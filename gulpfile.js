...
gulp.task('devWatch', function () {
    ...
    //less文件修改 ，注入css
    gulp.watch('src2/**/*.less', ['changeLessDev']);

    //html,js文件修改，重新拼接，刷新
    gulp.watch('src2/**/*.{ejs,html}', ["fileIncludeDev"]);

    //html,js文件修改，重新拼接，刷新
    gulp.watch('src2/**/*.js', ['changeJsDev']);

  //html,js文件修改，重新拼接，刷新
  gulp.watch('src2/**/*.{png,jpg,gif}', ['imageMinDev']);
...
//打包
var dist = require('./gulp/dev/rev.js');
